...
public class ElementJoinGroupItem {
     ...
     */
    public ElementJoinGroupItem(String userId, String userNickName, String userHead, Integer status) {
        pane = new Pane();
        ...
        String statusText = "";
        if (GroupState.NOT_ADD.getStateCode().equals(status)){
            statusText = "申请加入";
        } else if (GroupState.HAVE_ADDED.getStateCode() .equals(status)){
            statusText = "已添加";
        }
